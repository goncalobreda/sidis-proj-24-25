package com.example.lendingservice.infrastructure.repositories.impl;
...
public interface SpringDataLendingRepository extends CrudRepository<Lending, Long>, LendingRepository {
    ...
    @Override
    @Query("SELECT l FROM Lending l ORDER BY substring(l.lendingID, 1, 4), cast(substring(l.lendingID, 6, 10) AS int) DESC")
